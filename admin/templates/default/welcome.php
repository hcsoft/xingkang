                    ...
                    <div class="databox bg-white radius-bordered">
                        <div class="databox-left bg-themesecondary">
                            <div class="databox-piechart">
                                <div data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff"
                                     ...
                                     data-size="47" data-trackcolor="rgba(255,255,255,0.1)"  id="file_pie_rate"title="新增档案占比"><span class="white font-90" >0%</span>
                                </div>
                            </div>
                        </div>
                        <div class="databox-right">
                            ...
                            <div class="databox-text darkgray">
                                新增数<span id="file_new" class="databox-number themesecondary flip-counter light "
                    ...
                    <div class="databox bg-white radius-bordered">
                        <div class="databox-left bg-themethirdcolor">
                            <div class="databox-piechart">
                                <div data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff"
                                     data-linecap="butt" data-percent="0" data-animate="500" data-linewidth="3"
                                     data-size="47" data-trackcolor="rgba(255,255,255,0.2)" id="pregnant_pie_rate" title="新建册占比"><span class="white font-90">0%</span>
                                </div>
                            </div>
                        </div>
                        <div class="databox-right">
                    ...
                    <div class="databox bg-white radius-bordered">
                        <div class="databox-left bg-themeprimary">
                            <div class="databox-piechart">
                                <div  data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff"
                                     data-linecap="butt" data-percent="0" data-animate="500" data-linewidth="3"
                                     data-size="47" data-trackcolor="rgba(255,255,255,0.1)" id="chronic_pie_rate" title="高血压占比"><span class="white font-90">0%</span>
                                </div>
                            </div>
                        </div>
                        <div class="databox-right">
                    ...
                    <div class="databox bg-white radius-bordered">
                        <div class="databox-left bg-palegreen">
                            <div class="databox-piechart">
                                <div  data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff"
                                     data-linecap="butt" data-percent="0" data-animate="500" data-linewidth="3"
                                     data-size="47" data-trackcolor="rgba(255,255,255,0.1)" id="infectious_pie_rate" title="传染病报告占比"><span class="white font-90">0%</span>
                                </div>
                            </div>
                        </div>
                        <div class="databox-right">
...
//                    var myCounter = new flipCounter('file_new', {value: parseInt(data["file_new"]), inc: 1, pace: 1000, auto: false});
//                    myCounter.add(10);
