<div class="page">
  ...
  <table class="table tb-type2">
    ...
    <tbody>
      ...
      <tr class="noborder">
        <td></td>
        <td><a href="http://www.szgr.com.cn" target="_blank">http://www.szgr.com.cn</a></td>
      </tr>
    </tbody>
    <tfoot>
      <tr class="tfoot">
  ...
  <table class="table tb-type2">
    ...
    <tbody>
      ...
      <tr class="noborder">
        <td></td>
        <td><a href="http://www.szgr.com.cn" target="_blank"><?php echo $lang['dashboard_aboutus_thanks_developer_name']; ?></a></td>
      </tr>
    </tbody>
    <tfoot>
      <tr class="tfoot">
  ...
  <table class="table tb-type2">
    ...
    <tbody>
      <tr>
        <td class="w12"></td>
        <td><a href="http://www.szgr.com.cn" target="_blank"><?php echo $lang['dashboard_aboutus_notice1'];?></a>&nbsp;<?php echo $lang['dashboard_aboutus_notice2'];?>&nbsp;<a href="http://www.szgr.com.cn" target="_blank">ShopNC</a>&nbsp;<?php echo $lang['dashboard_aboutus_notice3'];?></td>
      </tr>
      <tr class="noborder">
        <td></td>
