...
var InitiateSparklineCharts = function () {
    return {
        ...
        update: function (selector) {
            ...
            /*Bar*/
            var sparklinebars = $(selector+' [data-sparkline=bar]');
            $.each(sparklinebars, function () {
                $(this).sparkline('html', {
                    type: 'bar',
                    disableHiddenCheck: true,
            ...
            /*Line*/
            var sparklinelines = $(selector+' [data-sparkline=line]');
            $.each(sparklinelines, function () {
                $(this).sparkline('html', {
                    type: 'line',
                    disableHiddenCheck: true,
            ...
            /*Composite Line*/
            var sparklinecompositelines = $(selector+' [data-sparkline=compositeline]');
            $.each(sparklinecompositelines, function () {
                $(this).sparkline('html', {
                    type: 'line',
                    disableHiddenCheck: true,
            ...
            /*Composite Bar*/
            var sparklinecompositebars = $(selector+' [data-sparkline=compositebar]');
            $.each(sparklinecompositebars, function () {
                $(this).sparkline('html', {
                    type: 'bar',
                    disableHiddenCheck: true,
            ...
            /*Tristate*/
            var sparklinetristates = $(selector+' [data-sparkline=tristate]');
            $.each(sparklinetristates, function () {
                $(this).sparkline('html', {
                    type: 'tristate',
                    disableHiddenCheck: true,
            ...
            /*Descrete*/
            var sparklinediscretes = $(selector+' [data-sparkline=discrete]');
            $.each(sparklinediscretes, function () {
                $(this).sparkline('html', {
                    type: 'discrete',
                    disableHiddenCheck: true,
            ...
            /*Bullet*/
            var sparklinebullets = $(selector+' [data-sparkline=bullet]');
            $.each(sparklinebullets, function () {
                $(this).sparkline('html', {
                    type: 'bullet',
                    disableHiddenCheck: true,
            ...
            /*Box Plot*/
            var sparklinebox = $(selector+' [data-sparkline=box]');
            $.each(sparklinebox, function () {
                $(this).sparkline('html', {
                    type: 'box',
                    disableHiddenCheck: true,
            ...
            /*Pie*/
            var sparklinepie = $(selector+' [data-sparkline=pie]');
            $.each(sparklinepie, function () {
                $(this).sparkline('html', {
                    type: 'pie',
                    disableHiddenCheck: true,
