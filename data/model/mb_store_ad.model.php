...
class mb_store_adModel extends Model{
    public function __construct(){
        parent::__construct('mb_store_ad');
    }
     ...
     * @return array
	 */
	public function getMbStoreAdList($condition, $page = null, $order = 'link_id asc', $field = '*'){
	 ...
	 */
	public function getMbStoreAdInfoByID($id){
		if (intval($id) > 0){
