...
class goods_class_tagModel extends Model{
	...
	public function tagAdd($param){
		...
		return Db::query("insert into [".MS_DBPRE."goods_class_tag] ([gc_id_1],[gc_id_2],[gc_id_3],[gc_tag_name],[gc_tag_value],[gc_id],[type_id]) values ".$condition_str);
	}
	...
	public function clearTag(){
		return Db::query("TRUNCATE TABLE [".MS_DBPRE."goods_class_tag]");
	}
