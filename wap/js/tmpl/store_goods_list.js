$(function(){	
	...
	var store_id = escape(GetQueryString('store_id'));
    ...
    if($("input[name=store]").val()!=''){
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list&key=4&page="+pagesize+"&curpage=1"+'&store_id='+$("input[name=store_id]").val(),
    		type:'get',
    		dataType:'json',
...
//    	}
    	var url = ApiUrl+"/index.php?act=goods&op=goods_list&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&store_id="+store_id;
