		...
		<div class="box-products slide" id="productcarousel9">
			<div class="carousel-controls">
				<a class="carousel-control left icon-angle-left"
					href="#productcarousel9" data-slide="prev"></a> <a
					class="carousel-control right icon-angle-right"
					href="#productcarousel9" data-slide="next"></a>
			</div>
			<div class="carousel-inner ">

				<?php if(count($mostview)>0){?>
				<?php foreach ($mostview as $i => $good){?>
				<?php if($i%4==0){?>
				...
				<?php if($i%4==3 || $i==count($mostview)-1){?>
					</div>
				</div>
				<?php }?>
				<?php }?>
