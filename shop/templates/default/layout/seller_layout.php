    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['act'] == 'seller_center'?"id='quicklink_".$submenu_value['act']."'":'';?>class="
          	<?php echo $submenu_value['act'] == $_GET['act']||($count==0&&stripos($_REQUEST['act'],"store_theme_setting_")==0)?'current':'';?>"> 
          	<a href="index.php?act=<?php echo $submenu_value['act'];?>&op=<?php echo $submenu_value['op'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php $count=$count+1;} ?>
          <?php } else { ?>
