...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/store/<?php echo $output['store_info']['store_theme'];?>/style.css" rel="stylesheet" type="text/css">
...
<header id="header">
  <div class="layout" style='font: 12px/20px Arial,Verdana,"宋体","Lucida Grande","Lucida Sans Unicode",Helvetica,sans-serif;'>
    <h1 id="shop-logo">
...
<?php if($output['store_info']['store_theme']=='default'){?>
<div class="ncsl-nav">
...
<?php }else{
	include BASE_PATH.'/templates/default/store/'.$output['store_info']['store_theme'].'/get_templates_data.php';
}?>
