...
<div class="ncu-form-style">
  ...
  <dl>
    <dt>&nbsp;</dt>
    <dd>
      <input id="btn_publish" type="submit" class="submit" value="<?php echo $lang['talk_send'];?>">
      <input id="btn_refresh" type="submit" class="submit" value="<?php echo $lang['talk_refresh'];?>">
      <input id="btn_handle" type="submit" class="submit" value="<?php echo $lang['handle_submit'];?>">
    </dd>
  </dl>
</div>
<?php } ?>
