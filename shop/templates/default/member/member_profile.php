  ...
  <div class="ncu-form-style">
    <form method="post" id="profile_form" action="index.php?act=home&op=member">
      ...
      <dl>
        ...
        <dd><span class="w340"><?php echo $output['member_info']['member_name']; ?></span><span>&nbsp;&nbsp;<?php echo $lang['home_member_privacy_set'];?></span></dd>
      </dl>
      <dl>
        <dt><?php echo $lang['home_member_email'].$lang['nc_colon'];?></dt>
        <dd><span class="w340"><?php echo $output['member_info']['member_email']; ?></span><span>
