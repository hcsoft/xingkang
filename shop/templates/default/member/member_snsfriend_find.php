  ...
  <div class="friendfind"> 
    ...
    <div class="recommend-tag mt10 mb20">
      ...
      <dl>
        ...
        <dd><div class="picture"><span class="thumb size100"><i></i><img title="<?php echo $val['mtag_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_MEMBERTAG.'/'.($val['mtag_img'] != ''?$val['mtag_img']:'default_tag.gif')?>"  onload="javascript:DrawImage(this,120,120);"/></span></div>
        <div class="arrow"></div>
            ...
            <div>
              ...
              <div class="list" nctype="slider_div">
                <ul class="F-center"><?php $param = array();foreach ($param_memberlist as $v){ $param[] = $v['member_id'];?>
                  <li><span class="thumb size40"><i></i><a href="javascript:void(0);"><img title="<?php echo $v['member_name'];?>" src="<?php if ($v['member_avatar'] != ''){ echo SHOP_SITE_URL.DS. ATTACH_AVATAR.DS.$v['member_avatar'];}else { echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait');}?>"  onload="javascript:DrawImage(this,40,40);"/></a></span></li>
                <?php }?></ul>
              </div>
