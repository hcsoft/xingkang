...
<dl>
  ...
  <dd>
    <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&op=show_order&order_id=<?php echo $output['order_info']['order_id'];?>"  target="_blank"> <?php echo $output['order_info']['order_sn'];?> </a>
  </dd>
