...
<table class="ncsc-table-style" id="my_category" server="index.php?act=store_goods_class&op=goods_class_ajax" >
  <thead>
  ...
  <tbody id="treet1">
    ...
    <tr class="bd-line" nc_type="table_item" idvalue="<?php echo $val['stc_id']; ?>" >
      ...
      <td><?php if ($val['stc_state'] == 1) { ?>
        <span nc_type="editobj" class="showclass-ico-btn" status="on"></span>
        <?php } else { ?>
        <span nc_type="editobj"class="noshowclass-ico-btn" status="off"></span>
        <?php } ?></td>
