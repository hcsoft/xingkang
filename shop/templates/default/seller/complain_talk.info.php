...
<div class="bottom">
  <label class="submit-border">
    <a id="btn_publish" class="submit"><?php echo $lang['talk_send'];?></a>
  </label>
  <label class="submit-border">
    <a id="btn_refresh" class="submit"><?php echo $lang['talk_refresh'];?></a>
  </label>
  <label class="submit-border">
    <a id="btn_handle" class="submit"><?php echo $lang['handle_submit'];?></a>
  </label>
</div>
<?php } ?>
