...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?act=store_setting&op=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      <dt>商铺地址:</dt>
      <dd>
        <input class="w200 text" name="address" type="text"  id="address" value="<?php echo $output['store_info']['address'];?>" />
      </dd>
    </dl>
    <dl>
      <dt>联系电话:</dt>
      <dd>
        <input class="w200 text" name="phone" type="text"  id="phone" value="<?php echo $output['store_info']['phone'];?>" />
      </dd>
    </dl>
    <dl>
      <dt>百度地图坐标:</dt>
      <dd>
        <input class="w200 text" name="location" type="text"  id="location" value="<?php echo $output['store_info']['location'];?>" />
      </dd>
    </dl>
    <dl>
      <dt>官方网站地址:</dt>
      <dd>
        <input class="w200 text" name="url" type="text"  id="url" value="<?php echo $output['store_info']['url'];?>" />
      </dd>
    </dl>
    <dl>
...
function call_back(picname){
	$('#store_logo').val(picname);
	$('img[nc_type="store_logo"]').attr('src','<?php echo UPLOAD_SITE_URL.'/'.ATTACH_STORE;?>/'+picname);
	$('#_pic').val('');
}
$(function(){
