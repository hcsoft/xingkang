<?php defined('InShopNC') or exit('Access Invalid!');?>
            ...
            <li> <a href="<?php echo thumb($v, 1240);?>" value="<?php echo $v['apic_id'] ?>"> <span class="thumb size90"><i></i> <img title="<?php echo $v['apic_name']?>" src="<?php echo thumb($v, 60);?>" class="image0" onload="javascript:DrawImage(this,90,90);"/>
