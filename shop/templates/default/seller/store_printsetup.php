<?php defined('InShopNC') or exit('Access Invalid!');?>
  ...
  <div class="ncsc-form-default">
    <form method="post" action="index.php?act=store_printsetup&op=index" enctype="multipart/form-data" id="my_store_form">
      ...
      <dl class="setup">
        ...
        <dd>
          ...
          <p class="picture">
          	...
          	<img src="<?php if(!empty($output['store_info']['store_stamp'])){echo UPLOAD_SITE_URL.'/'.ATTACH_STORE.'/'.$output['store_info']['store_stamp'];}?>"  onload="javascript:DrawImage(this,120,120);" nc_type="store_stamp" /></span> </p>
          <p>
