	  ...
	  <form id="add_form" method="post" enctype="multipart/form-data">
	    ...
	    <dl>
	      ...
	      <dd>
	        ...
	        <span></span><p class="hint"><?php echo $lang['voucher_template_enddate_tip'];?><?php echo @date('Y-m-d',$output['quotainfo']['quota_starttime']);?> ~ <?php echo @date('Y-m-d',$output['quotainfo']['quota_endtime']);?></p>
	      </dd>
	    </dl>
	    <dl>
