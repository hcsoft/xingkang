...
<div class="alert alert-block alert-info"> <strong><?php echo $lang['store_sns_type'].$lang['nc_colon'];?></strong>
  <label class="mr20">
      ...
      <dd>
        ...
        <div class="handle">
          <div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="ncsc-btn" nctype="get_img" href="index.php?act=store_album&op=pic_list&item=store_sns_normal"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_img" class="ncsc-btn ml5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="recommend_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w400"><span class="smile"><a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"recommend"}'><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_recommend" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="hotsell_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"hotsell"}'><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_hotsell" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
  ...
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="new_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="w450"><span class="smile"> <a href="javascript:void(0)" nc_type="smiliesbtn" data-param='{"txtid":"new"}'><?php echo $lang['store_sns_face'];?></a> </span> <span id="weibocharcount_new" class="weibocharcount"></span></p>
      </dd>
    </dl>
    <div class="bottom">
      <label class="submit-border"><input type="submit" class="submit" value="<?php echo $lang['store_sns_release'];?>" /></label>
