    ...
    <div class="ncsc-picture-list">
      ...
      <ul>
        ...
        <li>
          <dl>
            <dt>
              <div class="picture"><a href="index.php?act=store_album&op=album_pic_info&id=<?php echo $v['apic_id'];?>&class_id=<?php echo $v['aclass_id']?><?php if(!empty($_GET['sort'])){?>&sort=<?php echo $_GET['sort']; }?>&curpage=<?php echo ceil((12*($curpage-1)+$ii)/7);?>&start_index=<?php echo ($tmp = (12*($curpage-1)+$ii)%7) ? $tmp-1 :6;?>"> <img id="img_<?php echo $v['apic_id'];?>" src="<?php echo thumb($v, 240);?>"></a></div>
