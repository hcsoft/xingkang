...
<div class="ncsc-store-templet">
  <dl class="current-style">
    ...
    <dd><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']));?>" target="_blank" class="ncsc-btn"><?php echo $lang['store_theme_homepage'];?></a>
    <?php if($output['curr_theme']['curr_name']!='default'){?>
    	<a href="<?php echo urlShop('store_theme_setting_'.$output['curr_theme']['curr_name'], 'theme_setting');?>"  class="ncsc-btn">主题设置</a>	
    <?php }?>
    </dd>
  </dl>
...
function preview_theme(style_name){
    var screenshot = '<?php echo SHOP_TEMPLATES_URL;?>/store/' + style_name + '/screenshot.jpg';
