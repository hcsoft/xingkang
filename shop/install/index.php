...
<div class="footer">
  ...
  <h6>版权所有 2007-2014 &copy; <a href="http://www.szgr.com.cn" target="_blank">天津市网城天创科技有限责任公司</a></h6>
...
function step3(&$install_error,&$install_recover){
    ...
    if(DBDRIVER=='mssql'){
        $db->query("UPDATE `{$db_prefix}navigation` SET nav_url= '{$auto_site_url}/'+nav_url");
        $db->query("UPDATE `{$db_prefix}cms_navigation` SET navigation_link='{$auto_site_url}/'+navigation_link");
    }else{
